...
public class EconomyActivity extends AppCompatActivity {
    ...
    public void GoToNewsTwo() {
        TextView NewsTwo = (TextView) findViewById(R.id.EconomyNewsTwo);
    ...
    public void RequestsTopTwoNews(String url) {
        ...
        final TextView title1 = (TextView) findViewById(R.id.EconomyNewsOne);
        final TextView title2 = (TextView) findViewById(R.id.EconomyNewsTwo);
        ...
        final TextView tagView1 = (TextView) findViewById(R.id.EconomyTagOne);
        final TextView tagView2 = (TextView) findViewById(R.id.EconomyTagTwo);
...
// Add the request to the RequestQueue.
    ...
    {
        ImageView SearchBut=(ImageView) findViewById(R.id.economyToHome);
        SearchBut.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {//switch to new activity
                Intent intent = new Intent(EconomyActivity.this, NewsOverviewActivity.class);
                startActivity(intent);
            }
        });
    }
